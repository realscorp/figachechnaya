...
- Gitlab CI
А ещё это способ показать моё понимание принципов построения микросервисного приложения, моих профессиональных ценностей и просто повод немного повеселиться :)
## Техническое задание
...
### Овнер продукта хочет следующую функциональность
...
- Запуск в Kubernetes
- Запуск в облаке
- Для ускорения запуска и упрощения создания отдельных DEV, STAGE и QA-окружений будет использоваться DBaaS в облаке
